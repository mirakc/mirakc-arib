...
assert 0 "$MIRAKC_ARIB record-service --id=a --sid=1 --file=file --chunk-size=8192 --num-chunks=1"
assert 0 "$MIRAKC_ARIB record-service --id=a --sid=0xFFFF --file=file --chunk-size=0x7FFE0000 --num-chunks=0x7FFFFFFF"
assert 134 "$MIRAKC_ARIB record-service --id=a --sid=1 --file=file --chunk-size=0 --num-chunks=1"
